                    ...
                    <form action="adminLogin.php" method="post">
                        ...
                        <div class="my-5">
                            ...
                            <div class="form-outline mb-3">
                                ...
                                <input type="password" name="pass" class="form-control form-control-lg" placeholder="Enter password" />
                            </div>

                            <div class="text-center text-lg-start mt-4 pt-2">
                                <button type="submit" class="btn btn-primary btn-sm" style="padding-left: 2.5rem; padding-right: 2.5rem">
                                    Login
                                </button>
                                <a href="index.php" class="btn btn-primary btn-sm mx-2" style="padding-left: 2.5rem; padding-right: 2.5rem">Home</a>
                            </div>
                        </div>
                    </form>
                </div>
